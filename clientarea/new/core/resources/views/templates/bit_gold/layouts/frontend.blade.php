    ...
    <div class="header__bottom">
      <div class="container">
        <nav class="navbar navbar-expand-xl p-0 align-items-center">
          <a class="site-logo site-title" href="../../../../../../../index.html"><img src="{{getImage(imagePath()['logoIcon']['path'] .'/logo.png')}}" alt="site-logo"></a>
          <ul class="account-menu responsive-account-menu ml-3">
            @guest
            <li class="icon"><a href="{{ route('user.login') }}"><i class="las la-user"></i></a></li>
            @else
            <li class="icon"><a href="../../../../../../../index.html"><i class="las la-user"></i></a></li>
            @endif
          </ul> 
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav main-menu ml-auto">
              <li> <a href="../../../../../../../corporate/index.html">@lang('Corporate')</a></li>
              <li><a href="../../../../../../../operations/index.html">@lang('Operations')</a></li>
              <li><a href="../../../../../../../investors/index.html">@lang('Investors')</a></li>
              <li><a href="../../../../../../../media-room/index.html">@lang('Media Room')</a></li>
              <li><a href="../../../../../../../digital-mining-101/index.html">@lang('Digital Mining 101')</a></li>
            </ul>
            <div class="nav-right">
    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-lg-12 text-center">
          <a href="https://nthosting-hostname.ddns.net"><img src="{{getImage(imagePath()['logoIcon']['path'] .'/logo.png')}}" alt="image"></a>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-6 text-md-left text-center">
          <p><p>@lang('© '.date('Y').' <a href="https://nthosting-hostname.ddns.net" class="base--color">'.$general->sitename.'</a>. All rights reserved')</p></p>
        </div>
        <div class="col-md-6">
